...
## WORKFLOW PER TASK
Plan (≤3 bullets) → edit complete files → changed-files list → MISSING ASSETS list.
Ambiguous? choose the most Rams-restrained option and note the assumption. One route per turn.
If you truncate a long file, resume with "continuing FILE: <path> from <last line>".
