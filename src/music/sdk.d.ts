...
// FILE: src/music/sdk.d.ts
// The slice of the two vendor SDKs the sound dock uses, typed from their
...
interface ImportMetaEnv {
  ...
  readonly VITE_SPOTIFY_HOUSE_PLAYLIST?: string
  readonly VITE_APPLE_MUSIC_HOUSE_PLAYLIST?: string
}
