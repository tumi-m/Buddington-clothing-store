// FILE: src/music/links.ts
// Turns a pasted Spotify / Apple Music share link into something the sound
// dock can play. This is the only place shopper input reaches an <iframe src>,
...
function parseApple(input: string): MusicLink | null {
  ...
  if (url.protocol !== 'https:' || (host !== 'music.apple.com' && host !== 'embed.music.apple.com')) {
    return null
  }
