...
describe('apple music links', () => {
  it('reads a playlist link', () => {
    ...
    assert.deepEqual(link, {
      ...
      openUrl: 'https://music.apple.com/gb/playlist/todays-hits/pl.f4d106fed2bd41149aaacabb233eb5eb',
      storefront: 'gb',
    })
  })
  ...
  it('treats an album link with ?i= as that one song', () => {
    ...
    assert.equal(link?.embedUrl, 'https://embed.music.apple.com/us/album/blue/1440857781?i=1440857782')
  })
...
describe('untrusted input', () => {
  ...
  it('never carries a hostile slug into the embed url', () => {
    const link = parseMusicLink(
      'https://music.apple.com/us/album/%22%3E%3Cscript%3E/1440857781',
    )
  ...
  it('refuses absurdly long input', () => {
    assert.equal(parseMusicLink(`https://open.spotify.com/playlist/${PL}?x=${'a'.repeat(3000)}`), null)
  })
})
...
describe('apple queue', () => {
  it('maps each playable kind to the MusicKit queue option', () => {
    ...
    assert.deepEqual(q('https://music.apple.com/us/playlist/x/pl.u-8aAVZAoFVlDZvV'), { playlist: 'pl.u-8aAVZAoFVlDZvV' })
    assert.deepEqual(q('https://music.apple.com/us/album/x/1440857781'), { album: '1440857781' })
    assert.deepEqual(q('https://music.apple.com/us/album/x/1440857781?i=1440857782'), { song: '1440857782' })
  })
