...
export function FlightHUD({ progress, done, onSkip }: FlightHUDProps) {
  ...
  return (
    ...
    >
      {/* Chapter label — bottom-left, folio grammar, clear of the home indicator */}
      <p
        ref={chapterRef}
        className="absolute left-4 sm:left-6 font-mono uppercase text-[0.6rem] sm:text-[0.65rem] tracking-[0.14em] text-paper/70 select-none"
      ...
      {/* Scroll / swipe cue — centre, fades once the descent begins */}
      <div
        ref={cueRef}
        className="absolute inset-x-0 flex flex-col items-center gap-2 transition-opacity duration-500 select-none"
